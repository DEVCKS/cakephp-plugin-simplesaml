...
class SimpleSamlPhpConfig
{
    static public function getConfig(): array
    {
        ...
        $baseConfig = [
            ...
            *******************************/
             ...
             * root directory.
             */
            'loggingdir' => '/script/plugins/SimpleSaml/logs',
            //'datadir' => '/var/data/',
    ...
    */
             ...
             */
            'secretsalt' => '1880474bf23e3a17b0a6ed76632c9572bf0cd8aabab3ae867789b6516fbf6957',
        ...
        */
        ...
        return self::overrideConf('config', $baseConfig);
    }

    static public function getAuthSources(): array
    {
        $baseConfig = [
        ...
        return self::overrideConf('authsources', $baseConfig);
    }

    static public function getAcl(): array
    {
        $baseConfig = [
            'adminlist' => [
